...
const DesignArea = () => {
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
            ...
            {Object.entries(viewMeta).map(([key, meta]) => (
              <Button
                ...
                className={`rounded-full border whitespace-nowrap ${
                  selectedView === key ? "shadow-md" : "border-dashed"
                }`}
              >
                {meta.label}
              </Button>
      ...
      {/* Canvas Area */}
      <Card className="w-full border-none shadow-xl bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 text-slate-50 overflow-hidden">
        ...
        <CardContent className="p-0 w-full overflow-hidden">
          ...
          <div className="relative isolate w-full">
            ...
            <div className="relative z-10 p-4 sm:p-6 w-full">
              ...
              <div className="w-full max-w-xl h-[420px] mx-auto flex items-center justify-center">

                <div className="relative w-full max-w-lg px-2 sm:px-4">

                  <div
                    className="absolute inset-0 rounded-2xl bg-slate-950/60 border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.35)] pointer-events-none"
                    aria-hidden
                  />
