...
const ToolBar = ({ manualSync }) => {
  ...
  return (
    <div className="flex flex-col gap-6 w-[240px] min-w-[220px] h-[90vh] ml-6 overflow-y-auto">

      {/* Setup Section */}

      <div className="rounded-xl border bg-white/70 shadow-sm p-4 space-y-3">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-[11px] uppercase tracking-[0.2em] text-muted-foreground font-semibold">
              Setup
      ...
      <div className="rounded-xl border bg-white/70 shadow-sm p-4 space-y-2">
        <div className="grid grid-cols-2 gap-2">
          <Button
            onClick={handleDelete}
            variant="destructive"
