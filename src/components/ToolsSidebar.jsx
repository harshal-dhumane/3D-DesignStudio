...
//       <SheetContent
//         side="left"
//         className="w-[90vw] max-w-[380px] p-4 sm:p-6"
//       >
//         <SheetHeader>
//           <SheetTitle className="text-left">Design Console</SheetTitle>
//         </SheetHeader>
...
//       {/* Desktop Sidebar */}
//       <div className="hidden lg:block">
//         <div className="w-[320px] min-w-[300px] rounded-3xl border bg-gradient-to-b from-white via-slate-50 to-white shadow-xl">
//           <div className="p-5 space-y-4">
//             <div className="flex items-center justify-between">
//               <div>
//                 <p className="text-xs uppercase tracking-[0.25em] text-muted-foreground font-semibold">
...
export function ToolsSidebar({ manualSync }) {
  return (
    <Sheet>
      ...
      <SheetContent side="left" className="w-[90vw] max-w-[380px] p-4 sm:p-6">
        <SheetHeader>
          <SheetTitle className="text-left">Design Console</SheetTitle>
        </SheetHeader>
      ...
      {/* Desktop Sidebar */}
      <div className="hidden lg:block">
        <div className="w-[320px] min-w-[300px] rounded-3xl border bg-white shadow-xl">
          <div className="p-5 space-y-4">
            <ScrollArea className="max-h-[72vh] pr-2">
              <div className="space-y-4">
                <ToolBar manualSync={manualSync} />
